...
parser.add_argument('--lambda_u', default=125, type=float, help='weight for unsupervised loss')
parser.add_argument('--p_threshold', default=0.5, type=float, help='clean probability threshold')
parser.add_argument('--T', default=0.5, type=float, help='sharpening temperature')
parser.add_argument('--num_epochs', default=300, type=int)
parser.add_argument('--r', default=0.402, type=float, help='noise ratio')
...
if __name__ == '__main__':
    ...
    for epoch in range(args.num_epochs+1):
        ...
        if epoch < warm_up:  
            ...
            print('Warmup Net1')
            warmup(epoch,net1,optimizer1,warmup_trainloader, plot=1)
            print('\nWarmup Net2')
            warmup(epoch,net2,optimizer2,warmup_trainloader, plot=2)
            if epoch == 29:
                torch.save(net1.state_dict(), './checkpoint/warmup_net1.pt')
